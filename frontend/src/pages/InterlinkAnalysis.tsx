    ...
    >
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-center mb-8 max-w-md mx-auto">
              Upload two transaction data files to analyze and compare for
              hidden connections and interlinked activity.
            </p>
            <FileUpload
      ...
      <div className="mt-16 w-full max-w-4xl flex flex-col md:flex-row justify-center items-center gap-8">
        <Step
          number={1}
          title="Upload CSVs"
          description="Select and upload two transaction data files for comparison."
        />
        <Step
          number={2}
        ...
        <Step
          ...
          description="Explore interlinked activity, shared entities, and network graphs."
        />
      </div>
      ...
      >
        <p>
          Supported format: CSV &nbsp; | &nbsp; Max file size: 10MB per file
        </p>
      </motion.div>
